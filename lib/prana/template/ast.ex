defmodule Prana.Template.AST do
  ...
  @doc "Create a for loop AST node"
  def for_loop(variable, iterable, body) do
    {:for_loop, [], [variable, iterable, body]}
  end

  @doc "Create an if condition AST node"
  def if_condition(condition, then_body, else_body) do
